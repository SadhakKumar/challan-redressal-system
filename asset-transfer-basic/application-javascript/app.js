...
app.post('/assets', async (req, res) => {
	try {
		const { challanNo, carNo, challanAmount, reason, owner, proof } = req.body;
		const result = await contract.submitTransaction('CreateAsset', challanNo, carNo, challanAmount, reason, owner, proof);
		res.send(result.toString());
	} catch (error) {
...
app.put('/assets/:id', async (req, res) => {
	try {
		const { carNo, challanAmount, reason, owner, proof } = req.body;
		const result = await contract.submitTransaction('UpdateAsset', req.params.id, carNo, challanAmount, reason, owner, proof);
		res.send(result.toString());
	} catch (error) {
